...
export const mockMediaItems: MediaItem[] = [
  ...
  // Books
  {
    ...
    description: 'From her place in the store, Klara, an artificial friend with outstanding observational qualities, watches carefully.',
    averageRating: 4.1,
    totalReviews: 1456,
  },
  {
  ...
  // Music
  {
    ...
    description: 'The stories of 13 sleepless nights scattered throughout my life.',
    averageRating: 4.3,
    totalReviews: 3421,
  },
  {
    ...
    description: 'A celebration of a club era when disco and house music was birthed from the minds of Black and LGBTQ+ pioneers.',
    averageRating: 4.5,
    totalReviews: 2156,
  },
]
